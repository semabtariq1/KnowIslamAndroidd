...
public class HadessActivity extends ListActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hadess_list);
    ...
    class LoadInbox extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(HadessActivity.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            HadessActivity.this, inboxList,
                            R.layout.ayat_list_item, new String[] { TAG_FROM, TAG_SUBJECT, TAG_DATE },
